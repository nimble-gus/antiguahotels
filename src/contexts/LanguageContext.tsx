...
const translations: Translations = {
  es: {
    ...
    'activities.people': 'personas',
    'activities.difficulty.easy': 'Fácil',
    'activities.difficulty.moderate': 'Moderado',
    'activities.difficulty.challenging': 'Difícil',
    'activities.difficulty.extreme': 'Extremo',
    
    // Packages Page
    'packages.title': 'Nuestros Paquetes',
    'packages.subtitle': 'Descubre experiencias completas en Antigua Guatemala',
    'packages.searchPlaceholder': 'Buscar paquetes...',
    'packages.filters': 'Filtros y Búsqueda',
    'packages.duration': 'Duración',
    'packages.participants': 'Participantes',
    'packages.price': 'Precio',
    'packages.anyDuration': 'Cualquier duración',
    'packages.anyParticipants': 'Cualquier grupo',
    'packages.anyPrice': 'Cualquier precio',
    'packages.search': 'Buscar',
    'packages.clearFilters': 'Limpiar Filtros',
    'packages.noResults': 'No se encontraron paquetes',
    'packages.tryDifferentFilters': 'Intenta con diferentes filtros de búsqueda',
    'packages.featured': 'Paquete',
    'packages.days': 'días',
    'packages.nights': 'noches',
    'packages.people': 'personas',
    'packages.rooms': 'habitaciones',
    'packages.viewDetails': 'Ver detalles',
  ...
  en: {
    ...
    'activities.people': 'people',
    'activities.difficulty.easy': 'Easy',
    'activities.difficulty.moderate': 'Moderate',
    'activities.difficulty.challenging': 'Challenging',
    'activities.difficulty.extreme': 'Extreme',
    
    // Packages Page
    'packages.title': 'Our Packages',
    'packages.subtitle': 'Discover complete experiences in Antigua Guatemala',
    'packages.searchPlaceholder': 'Search packages...',
    'packages.filters': 'Filters and Search',
    'packages.duration': 'Duration',
    'packages.participants': 'Participants',
    'packages.price': 'Price',
    'packages.anyDuration': 'Any duration',
    'packages.anyParticipants': 'Any group',
    'packages.anyPrice': 'Any price',
    'packages.search': 'Search',
    'packages.clearFilters': 'Clear Filters',
    'packages.noResults': 'No packages found',
    'packages.tryDifferentFilters': 'Try with different search filters',
    'packages.featured': 'Package',
    'packages.days': 'days',
    'packages.nights': 'nights',
    'packages.people': 'people',
    'packages.rooms': 'rooms',
  ...
  fr: {
    ...
    'activities.people': 'personnes',
    'activities.difficulty.easy': 'Facile',
    'activities.difficulty.moderate': 'Modéré',
    'activities.difficulty.challenging': 'Difficile',
    'activities.difficulty.extreme': 'Extrême',
    
    // Packages Page
    'packages.title': 'Nos Forfaits',
    'packages.subtitle': 'Découvrez des expériences complètes à Antigua Guatemala',
    'packages.searchPlaceholder': 'Rechercher des forfaits...',
    'packages.filters': 'Filtres et Recherche',
    'packages.duration': 'Durée',
    'packages.participants': 'Participants',
    'packages.price': 'Prix',
    'packages.anyDuration': 'Toute durée',
    'packages.anyParticipants': 'Tout groupe',
    'packages.anyPrice': 'Tout prix',
    'packages.search': 'Rechercher',
    'packages.clearFilters': 'Effacer les Filtres',
    'packages.noResults': 'Aucun forfait trouvé',
    'packages.tryDifferentFilters': 'Essayez avec différents filtres de recherche',
    'packages.featured': 'Forfait',
    'packages.days': 'jours',
    'packages.nights': 'nuits',
    'packages.people': 'personnes',
    'packages.rooms': 'chambres',
    'packages.viewDetails': 'Voir détails',
    'packages.showing': 'Affichage',
    'packages.of': 'de',
    'packages.packages': 'forfaits',
  },
  ...
  de: {
    ...
    'activities.people': 'Personen',
    'activities.difficulty.easy': 'Einfach',
    'activities.difficulty.moderate': 'Moderat',
    'activities.difficulty.challenging': 'Herausfordernd',
    'activities.difficulty.extreme': 'Extrem',
    
    // Packages Page
    'packages.title': 'Unsere Pakete',
    'packages.subtitle': 'Entdecken Sie vollständige Erlebnisse in Antigua Guatemala',
    'packages.searchPlaceholder': 'Pakete suchen...',
    'packages.filters': 'Filter und Suche',
    'packages.duration': 'Dauer',
    'packages.participants': 'Teilnehmer',
    'packages.price': 'Preis',
    'packages.anyDuration': 'Beliebige Dauer',
    'packages.anyParticipants': 'Beliebige Gruppe',
    'packages.anyPrice': 'Beliebiger Preis',
    'packages.search': 'Suchen',
    'packages.clearFilters': 'Filter Löschen',
    'packages.noResults': 'Keine Pakete gefunden',
    'packages.tryDifferentFilters': 'Versuchen Sie es mit anderen Suchfiltern',
    'packages.featured': 'Paket',
    'packages.days': 'Tage',
    'packages.nights': 'Nächte',
    'packages.people': 'Personen',
    'packages.rooms': 'Zimmer',
    'packages.viewDetails': 'Details ansehen',
    'packages.showing': 'Anzeige',
    'packages.of': 'von',
