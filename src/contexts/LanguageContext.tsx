...
const translations: Translations = {
  es: {
    ...
    'header.accommodations': 'Habitaciones',
    ...
    'search.accommodations': 'Habitaciones',
    ...
    // Hotels
    'hotels.title': 'Hoteles en Antigua',
    'hotels.subtitle': 'Descubre los mejores hoteles boutique y experiencias únicas en el corazón de Guatemala',
    'hotels.search_placeholder': 'Buscar por nombre, ubicación o descripción...',
    'hotels.filters': 'Filtros',
    'hotels.price_range': 'Precio por noche:',
    'hotels.min_price': 'Min',
    'hotels.max_price': 'Max',
    'hotels.found_results': 'hotel encontrado',
    'hotels.found_results_plural': 'hoteles encontrados',
    'hotels.no_results': 'No se encontraron hoteles',
    'hotels.no_results_desc': 'Intenta ajustar tus filtros de búsqueda',
    'hotels.view_rooms': 'Ver Habitaciones',
    'hotels.rooms_count': 'habitaciones',
    'hotels.check_in': 'Check-in',
    'hotels.check_out': 'Check-out',
    'hotels.amenities_title': 'Amenidades del Hotel',
    'hotels.rooms_title': 'Habitaciones Disponibles',
    'hotels.filter_rooms': 'Filtrar Habitaciones',
    'hotels.guests': 'Huéspedes',
    'hotels.price_range_usd': 'Rango de Precio (USD)',
    'hotels.min_price_label': 'Precio mínimo',
    'hotels.max_price_label': 'Precio máximo',
    'hotels.amenities': 'Amenidades',
    'hotels.clear_filters': 'Limpiar Filtros',
    'hotels.room_found': 'habitación encontrada',
    'hotels.rooms_found': 'habitaciones encontradas',
    'hotels.no_rooms': 'No se encontraron habitaciones',
    'hotels.no_rooms_desc': 'Intenta ajustar tus filtros de búsqueda',
    'hotels.room_number': 'Habitación',
    'hotels.max_occupancy': 'Máx.',
    'hotels.people': 'personas',
    'hotels.floor': 'Piso',
    'hotels.per_night': 'por noche',
    'hotels.book_now': 'Reservar Ahora',
    'hotels.hotel_not_found': 'Hotel no encontrado',
    'hotels.back_to_hotels': 'Volver a Hoteles',
    
    // Activities Page
    'activities.title': 'Actividades y Experiencias',
    'activities.subtitle': 'Descubre las mejores experiencias que Antigua Guatemala tiene para ofrecerte',
    'activities.filters': 'Filtros y Búsqueda',
    ...
    'activities.allDifficulties': 'Todas las dificultades',
    'activities.duration': 'Duración (min)',
    'activities.anyDuration': 'Cualquier duración',
    'activities.participants': 'Participantes',
    'activities.anyParticipants': 'Cualquier cantidad',
    'activities.priceRange': 'Rango de Precio',
    'activities.results': 'Mostrando',
    'activities.of': 'de',
    'activities.activities': 'actividades',
    'activities.clearFilters': 'Limpiar Filtros',
    'activities.noResults': 'No se encontraron actividades',
    'activities.tryDifferentFilters': 'Intenta con diferentes filtros de búsqueda',
    'activities.featured': 'Destacada',
    'activities.minutes': 'minutos',
    'activities.availableSchedules': 'Horarios disponibles',
    'activities.viewDetails': 'Ver Detalles',
  },
  ...
  en: {
    ...
    // Hotels
    'hotels.title': 'Hotels in Antigua',
    'hotels.subtitle': 'Discover the best boutique hotels and unique experiences in the heart of Guatemala',
    'hotels.search_placeholder': 'Search by name, location or description...',
    'hotels.filters': 'Filters',
    'hotels.price_range': 'Price per night:',
    'hotels.min_price': 'Min',
    'hotels.max_price': 'Max',
    'hotels.found_results': 'hotel found',
    'hotels.found_results_plural': 'hotels found',
    'hotels.no_results': 'No hotels found',
    'hotels.no_results_desc': 'Try adjusting your search filters',
    'hotels.view_rooms': 'View Rooms',
    'hotels.rooms_count': 'rooms',
    'hotels.check_in': 'Check-in',
    'hotels.check_out': 'Check-out',
    'hotels.amenities_title': 'Hotel Amenities',
    'hotels.rooms_title': 'Available Rooms',
    'hotels.filter_rooms': 'Filter Rooms',
    'hotels.guests': 'Guests',
    'hotels.price_range_usd': 'Price Range (USD)',
    'hotels.min_price_label': 'Minimum price',
    'hotels.max_price_label': 'Maximum price',
    'hotels.amenities': 'Amenities',
    'hotels.clear_filters': 'Clear Filters',
    'hotels.room_found': 'room found',
    'hotels.rooms_found': 'rooms found',
    'hotels.no_rooms': 'No rooms found',
    'hotels.no_rooms_desc': 'Try adjusting your search filters',
    'hotels.room_number': 'Room',
    'hotels.max_occupancy': 'Max.',
    'hotels.people': 'people',
    'hotels.floor': 'Floor',
    ...
    'activities.subtitle': 'Discover the best experiences that Antigua Guatemala has to offer you',
    'activities.filters': 'Filters and Search',
    ...
    'activities.allDifficulties': 'All difficulties',
    'activities.duration': 'Duration (min)',
    'activities.anyDuration': 'Any duration',
    'activities.participants': 'Participants',
    'activities.anyParticipants': 'Any amount',
    'activities.priceRange': 'Price Range',
    'activities.results': 'Showing',
    'activities.of': 'of',
    'activities.activities': 'activities',
    'activities.clearFilters': 'Clear Filters',
    'activities.noResults': 'No activities found',
    'activities.tryDifferentFilters': 'Try with different search filters',
    'activities.featured': 'Featured',
    'activities.minutes': 'minutes',
    'activities.availableSchedules': 'Available schedules',
  ...
  fr: {
    ...
    'activities.subtitle': 'Découvrez les meilleures expériences qu\'Antigua Guatemala a à vous offrir',
    'activities.filters': 'Filtres et Recherche',
    'activities.searchPlaceholder': 'Rechercher des activités...',
    'activities.category': 'Catégorie',
    'activities.allCategories': 'Toutes les catégories',
    'activities.difficulty': 'Difficulté',
    'activities.allDifficulties': 'Toutes les difficultés',
    'activities.duration': 'Durée (min)',
    'activities.anyDuration': 'Toute durée',
    'activities.participants': 'Participants',
    'activities.anyParticipants': 'Toute quantité',
    'activities.priceRange': 'Gamme de Prix',
    'activities.results': 'Affichage',
    'activities.of': 'de',
    'activities.activities': 'activités',
    'activities.clearFilters': 'Effacer les Filtres',
    'activities.noResults': 'Aucune activité trouvée',
    'activities.tryDifferentFilters': 'Essayez avec différents filtres de recherche',
    'activities.featured': 'En Vedette',
    'activities.minutes': 'minutes',
    'activities.availableSchedules': 'Horaires disponibles',
    'activities.viewDetails': 'Voir Détails',
  },
  ...
  de: {
    ...
    // Activities Page
    'activities.title': 'Aktivitäten und Erlebnisse',
    'activities.subtitle': 'Entdecken Sie die besten Erlebnisse, die Antigua Guatemala Ihnen zu bieten hat',
    'activities.filters': 'Filter und Suche',
    ...
    'activities.allDifficulties': 'Alle Schwierigkeiten',
    'activities.duration': 'Dauer (min)',
    'activities.anyDuration': 'Beliebige Dauer',
    'activities.participants': 'Teilnehmer',
    'activities.anyParticipants': 'Beliebige Anzahl',
    'activities.priceRange': 'Preisbereich',
    'activities.results': 'Anzeige',
    'activities.of': 'von',
    'activities.activities': 'Aktivitäten',
    'activities.clearFilters': 'Filter Löschen',
    'activities.noResults': 'Keine Aktivitäten gefunden',
    'activities.tryDifferentFilters': 'Versuchen Sie es mit anderen Suchfiltern',
    'activities.featured': 'Empfohlen',
    'activities.minutes': 'Minuten',
    'activities.availableSchedules': 'Verfügbare Zeiten',
    'activities.viewDetails': 'Details Ansehen',
  }
}
